...
import hellorpc.annotation.HelloRPCSlf4jCommentItem;
import hellorpc.annotation.HelloRPCSlf4jComments;
 ...
 * @since 2015-07-07
 */
@HelloRPCSlf4jComments({
        @HelloRPCSlf4jCommentItem(dateTime = "2015-11-16 17:09", version = "v0.0.1", notes = {"创建本项目，完成通讯协议设计，完成报文格式解析相关工具类的开发。"})
})
public class HelloRPCSlf4jMain {

    public static final String VERSION = "v0.0.1";
    public static final String UPDATE_DATE_TIME = "2015-11-16 17:09";

    public HelloRPCSlf4jMain() {
    }
...
//        mainScrollPane.setViewportView(changeLogArea);
        ...
        mainFrame.add(new HelloRPCSlf4jChangeLogPanel(HelloRPCSlf4jMain.class), java.awt.BorderLayout.CENTER);
