 ...
 */
public class HelloRPCSlf4jChangeLogPanel extends javax.swing.JPanel {

    private Class<?> clazz;

    /** Creates new form ChangeLogPanel */
    public HelloRPCSlf4jChangeLogPanel(Class<?> clazz) {
        this.clazz = clazz;
        initComponents();
        initTable();
    }
    ...
    public DefaultTableModel getTableModel() {
        ...
        HelloRPCSlf4jComments commentsAnnotation = clazz.getAnnotation(HelloRPCSlf4jComments.class);
        if (commentsAnnotation != null) {
            HelloRPCSlf4jCommentItem[] commentItems = commentsAnnotation.value();
            if (commentItems != null) {
                for (HelloRPCSlf4jCommentItem item : commentItems) {
